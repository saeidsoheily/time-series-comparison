...
%Compute Gaussian Dynamic Time Warping Kernel between two time series X and Y with S-C Band 
%-------------------------------------------------------------------------------------------
function [size_warping_path, path, gdtw_similarity] = function_gdtw(X, Y, sakoe_chiba_band, sigma)
...
%Compute Gaussian Dynamic Time Warping Kernel Similarity
%-------------------------------------------------------------------------------------------
gdtw_similarity = exp(-(dtw_distance) / (sigma));
